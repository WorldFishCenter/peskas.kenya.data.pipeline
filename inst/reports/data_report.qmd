...
valid_data <-
  peskas.kenya.data.pipeline::mdb_collection_pull(
    connection_string = conf$storage$mongodb$cluster$pipeline$connection_string,
    collection_name = conf$storage$mongodb$cluster$pipeline$collection$v1$validated,
    db_name = conf$storage$mongodb$cluster$pipeline$database
  ) |>
  dplyr::as_tibble()
...
export_data <-
  peskas.kenya.data.pipeline::mdb_collection_pull(
    ...
    collection_name = conf$storage$mongodb$cluster$dashboard$collection$v1$catch_monthly,
