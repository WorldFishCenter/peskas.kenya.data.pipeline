...
# tracks_all <- furrr::future_map_dfr(
#   as.character(raw_tracks),
#   function(track_file) {
#     coasts::download_cloud_file(
#       name = track_file,
...
#   tracks_all |> 
#   janitor::clean_names() |>
#   dplyr::select(-c("community", "boat")) |> 
#   dplyr::mutate(time = lubridate::floor_date(time, unit = "5 minutes")) |>
#   dplyr::left_join(devices, by = "boat_name") |>
#   dplyr::rename(boat = "boat_name") |> 
#   dplyr::filter(!is.na(region)) |>
#   dplyr::group_by(region, boat, trip, time) |>
#   dplyr::summarise(dplyr::across(dplyr::everything(), ~ mean(.x)), .groups = "drop") |>
#   dplyr::filter(lng > 38.18)
# arrow::write_parquet(tracks_clean, "inst/reports/pds/tracks_binned_09-04.parquet")



# Load vessel tracking data (updated with latest trips)
tracks_binned <- 
arrow::read_parquet("tracks_binned_09-04.parquet") %>%
dplyr::filter(lng > 38.18)
