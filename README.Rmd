...
This package uses a configuration file (`config.yml` in the `inst/` directory) to manage environment-specific settings and connections. To get started, familiarize yourself with the package structure, particularly the `R/` directory where the main functions are located.
