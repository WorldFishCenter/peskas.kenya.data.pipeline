...
If you are joining to work on the **WCS side of the pipeline only**, start with the [WCS collaborator guide](WCS-GUIDE.md): it covers environment setup, the WCS data flow end to end, and the dedicated WCS workflow.
