# Contributing to peskas.kenya.data.pipeline

This outlines how to propose a change to peskas.kenya.data.pipeline. For
a detailed discussion on contributing to this and other tidyverse
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("WorldFishCenter/peskas.kenya.data.pipeline", fork = TRUE)`.
...
Please note that the peskas.kenya.data.pipeline project is released with
a [Contributor Code of
Conduct](https://worldfishcenter.github.io/peskas.kenya.data.pipeline/CODE_OF_CONDUCT.md).
