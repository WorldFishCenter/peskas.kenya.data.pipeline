...
This function retrieves KEFS (BMU DAILY ARTISANAL 2025) survey data from
their dedicated Kobo instance, processes it, and uploads the raw data as
a Parquet file to Google Cloud Storage.

## Usage

``` r
ingest_kefs_surveys_v1(log_threshold = logger::DEBUG)
```
