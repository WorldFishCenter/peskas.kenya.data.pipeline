...
Downloads preprocessed KEFS survey data, transforms it into the
canonical API schema, and uploads a parquet file to cloud storage. This
is the **raw/preprocessed** stage of the two-stage API export pipeline
(KEFS only; WCS is included at the validated stage via
